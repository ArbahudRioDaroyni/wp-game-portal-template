        ...
        <div class="nk-blog-post nk-blog-post-single">
          ...
          <?php
            ...
            while ( have_posts() ) :
              ...
              get_template_part( 'template-parts/content/content', 'file' );
...
<!-- END: Login Modal -->
<script type='text/javascript' src="<?= get_template_directory_uri() ?>/assets/js/custom.js?ver=1.33" defer></script>
<?php get_footer() ?>